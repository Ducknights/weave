...
public class ClubApiResponse<T> extends ApiResponse<T>{
    ...
    public static <T> ClubApiResponse<T> deleteSuccess(T data) {
        return of(ClubApiStatus.DELETE_SUCCESS, data);
    }
    public static <T> ClubApiResponse<T> deleteFail(T msg) {
        return of(ClubApiStatus.DELETE_FAIL, msg);
    }
